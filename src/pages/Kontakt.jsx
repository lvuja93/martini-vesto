        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 text-black p-4">
            <div className="flex flex-col lg:flex-row w-full max-w-6xl p-10 bg-white shadow-md space-y-8 lg:space-y-0 lg:space-x-8 mt-24">
                <div className="w-full p-0 max-w-lg">
                    <h2 className="text-2xl pb-8 text-center">Postavite nam pitanje</h2>
                    <EmailForm1 />
                </div>
                <div className="w-full lg:w-1/2 py-24 flex flex-col items-center justify-center space-y-8 bg-gray-200 rounded-xl text-xl">

                    <div className='flex items-center space-x-4 p-2 rounded-md hover:text-[#f5821f] transition duration-300 cursor-pointer'>
